...
// PollCategory defines domain classification
type PollCategory string

const (
	CategoryTechnology    PollCategory = "technology"
	CategoryEducation     PollCategory = "education"
	CategorySports        PollCategory = "sports"
	CategoryEntertainment PollCategory = "entertainment"
	CategoryGeneral       PollCategory = "general"
)
...
type Poll struct {
	...
	Category    PollCategory  `bson:"category" json:"category"`
...
// PollFilter encapsulates query parameters for listing polls
type PollFilter struct {
	Search    string
	Category  string
	Status    string
	CreatorID string
	SortBy    string // "newest", "most_voted", "expiring_soon", "oldest"
	Page      int
	Limit     int
}
