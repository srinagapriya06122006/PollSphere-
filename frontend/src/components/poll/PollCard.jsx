...
import { Clock, Activity, ArrowRight, CheckCircle2, User, Vote, Hourglass, Eye } from 'lucide-react'
          ...
          <div className="pt-4 mt-4 border-t border-slate-200 dark:border-slate-800/80 flex items-center justify-between text-xs text-slate-600 dark:text-slate-400 font-semibold">
            ...
            <div className="flex items-center gap-3">
              ...
              <button
                ...
                className="text-indigo-600 dark:text-indigo-400 font-black hover:text-indigo-700 dark:hover:text-indigo-300 transition-colors inline-flex items-center gap-1 px-2 py-1 rounded-lg hover:bg-indigo-50 dark:hover:bg-indigo-950/40"
              >
                <span>Vote</span>
