...
export const HowItWorks = () => {
  ...
  return (
    <section id="how-it-works" className="w-full py-16 sm:py-20 lg:py-24 bg-white dark:bg-slate-900/30 border-y border-slate-200/60 dark:border-slate-800/60 transition-colors duration-200">
